...
- `AndroidGarage/iosApp/SnapshotTests/PreviewTests.generated.swift` — generated by the `prefire` CLI (committed, clearly marked generated).
...
- **No coverage check.** Android's `checkPreviewCoverage` ensures every `@Preview` is captured; the iOS equivalent (assert every `#Preview` has a generated test) is a deferred follow-up. Today the generated file is committed and regenerated by the script.
