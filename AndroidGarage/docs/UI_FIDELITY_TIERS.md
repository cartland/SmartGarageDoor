...
- **(a) Offsets + the 3 mappings** — a **no-op hoist** (like palette): the 5 offset constants + `offset`/`overlay`/`colorState` data, shared + pinned. Ship via the verified-no-op recipe above.
