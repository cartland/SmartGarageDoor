...
**Files:** `MobileGarage/android-screenshot-tests/SCREENSHOT_GALLERY.md`, 18 screenshot PNGs under `android-screenshot-tests/src/screenshotTestDebug/reference/`, `MobileGarage/androidApp/src/main/java/com/chriscartland/garage/ui/SnoozeNotificationCard.kt`.
