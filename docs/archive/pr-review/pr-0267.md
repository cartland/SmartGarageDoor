...
**Files:** `MobileGarage/androidApp/src/main/java/com/chriscartland/garage/ui/theme/Color.kt`, `test/.../ThemeContrastTest.kt` (new), `ContrastCheck.kt` (new), `buildSrc/.../HardcodedColorCheckTask.kt` (new), `build.gradle.kts`, `scripts/validate.sh`, 11 screenshot PNGs.
