...
**Files:** `MobileGarage/domain/src/commonMain/kotlin/com/chriscartland/garage/domain/repository/DoorRepository.kt`, `data/.../NetworkDoorRepository.kt`, `NetworkDoorRepositoryIntegrationTest.kt`, `test-common/.../FakeDoorRepository.kt`, `AppComponent.kt`.
