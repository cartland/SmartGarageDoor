...
**Files:** `MobileGarage/androidApp/ui/GarageDoorButton.kt` (new, 206 lines), `NetworkProgressDiagram.kt` (new, 321 lines), `RemoteButtonDiagramMapping.kt` (new), delete `Parallelogram.kt`, `RemoteButtonContent.kt`, `RemoteButtonDiagramMappingTest.kt` (new), many other files + 48 screenshot PNGs.
