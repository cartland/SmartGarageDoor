...
**Files:** `MobileGarage/usecase/src/commonTest/.../DefaultAuthViewModelTest.kt` (new), `DefaultAppSettingsViewModelTest.kt` (new), `testfakes/*` (5 new files), `test-coverage-exemptions.txt`.
