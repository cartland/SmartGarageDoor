...
**Files:** `MobileGarage/data/build.gradle.kts` (new), `data/src/main/kotlin/.../LocalDoorDataSource.kt`, `settings.gradle.kts`, delete `androidApp/.../LocalDoorDataSource.kt`, `DoorRepository.kt`, `DoorRepositoryTest.kt`, `androidApp/build.gradle.kts`.
