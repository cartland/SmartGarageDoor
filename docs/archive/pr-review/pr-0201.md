...
**Files:** `MobileGarage/data/src/commonMain/.../ktor/KtorHttpClientFactory.kt` (new), `PlatformHttpEngine.kt` (new), `data/src/androidMain/.../PlatformHttpEngine.android.kt` (new), delete `androidApp/.../KtorHttpClientProvider.kt`, `data/build.gradle.kts`, `androidApp/build.gradle.kts`, `AppComponent.kt`.
