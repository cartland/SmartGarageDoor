...
**Files:** `MobileGarage/androidApp/.../settings/AppSettingsViewModel.kt`, `di/AppComponent.kt`, `ComponentProvider.kt` (new), `AndroidAppInfoCard.kt`, `LogSummaryCard.kt`, `UserInfoCard.kt`.
