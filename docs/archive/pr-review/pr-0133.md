...
**Files:** `MobileGarage/data/src/commonMain/.../NetworkDoorRepository.kt`, `NetworkPushRepository.kt`, `CachedServerConfigRepository.kt`, `AppComponent.kt`, `DECISIONS.md`, `CLAUDE.md`, test files.
