...
**Files:** `MobileGarage/data/src/commonTest/kotlin/.../NetworkDoorRepositoryIntegrationTest.kt` (new, 247 lines), `CachedServerConfigRepositoryTest.kt` (new), `testfakes/*` (3 new files), `data/build.gradle.kts`.
