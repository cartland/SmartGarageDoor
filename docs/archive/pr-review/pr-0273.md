...
**Files:** `MobileGarage/android-screenshot-tests/collections/app-overview.{md,yaml}`, `button-flow.{md,yaml}`, `scripts/generate-screenshot-collections.sh`, `generate-android-screenshots.sh`.
