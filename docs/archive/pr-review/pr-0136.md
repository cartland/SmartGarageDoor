...
**Files:** `MobileGarage/buildSrc/src/main/kotlin/importboundary/ImportBoundaryCheckTask.kt` (new, 79 lines), `domain/build.gradle.kts`, `data/build.gradle.kts`, `usecase/build.gradle.kts`, `scripts/validate.sh`.
