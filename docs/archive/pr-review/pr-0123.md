...
**Files:** `MobileGarage/androidApp/src/main/java/com/chriscartland/garage/ui/GarageDoorCanvas.kt` (new, 165 lines), `AnimatableGarageDoor.kt`, `RemoteButtonContent.kt`, delete 2 XML drawables, 19 screenshot PNGs.
