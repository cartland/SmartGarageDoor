...
**Files:** `MobileGarage/android-screenshot-tests/**`, `androidApp/ui/FullScreenPreviews.kt` (later replaced by `TabPreviews.kt`), `DoorStatusCard.kt`, `HomeContent.kt`, `ProfileContent.kt`, `scripts/generate-screenshot-collections.sh`.
