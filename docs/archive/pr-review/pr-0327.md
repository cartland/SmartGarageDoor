...
**Files:** `MobileGarage/domain/.../AuthRepository.kt`, `data/.../FirebaseAuthRepository.kt`, `usecase/.../EnsureFreshIdTokenUseCase.kt`, `test-common/.../FakeAuthRepository.kt`, use case tests.
