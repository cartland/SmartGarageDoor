...
**Files:** `MobileGarage/androidApp/.../config/ServerConfigRepository.kt`, `internet/RetrofitNetworkConfigDataSource.kt` (new), delete `config/model/ServerConfig.kt`, `ServerConfigRepositoryTest.kt`, `PushRepositoryTest.kt`.
