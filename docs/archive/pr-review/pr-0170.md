...
**Files:** `MobileGarage/androidApp/.../MainActivity.kt`, `DoorViewModel.kt`, `DoorFcmRepository.kt`, `FcmRegistration.kt`, `DoorHistoryContent.kt`, `HomeContent.kt`, `RegisterFcmUseCase.kt`, test files.
