...
**Files:** `MobileGarage/usecase/.../CheckInStalenessManager.kt` (new), `DoorViewModel.kt`, `CheckInStalenessManagerTest.kt` (new), `DoorViewModelTest.kt`, `AppStartup.kt`, `AppComponent.kt`, `AppStartupTest.kt`.
