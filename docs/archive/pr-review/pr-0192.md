...
**Files:** `MobileGarage/androidApp/src/main/java/com/chriscartland/garage/ui/Main.kt`, `buildSrc/.../NoNav2ImportsTask.kt` (new), `gradle/libs.versions.toml`, many `build.gradle.kts` files, `scripts/validate.sh`.
