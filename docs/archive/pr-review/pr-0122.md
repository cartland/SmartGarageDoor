...
**Files:** `.claude/skills/update-android-screenshots/SKILL.md`, `android-screenshot-tests/build.gradle.kts`, 34 screenshot PNGs, `MobileGarage/androidApp/ui/UiDemoData.kt`, `UserInfoCard.kt`, `scripts/generate-android-screenshots.sh`.
