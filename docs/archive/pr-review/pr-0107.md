...
**Files:** `MobileGarage/android-screenshot-tests/build.gradle.kts` (new), 3 screenshot test files, scripts, `.claude/skills/update-android-screenshots/SKILL.md` (new), `.github/workflows/ci.yml`, `settings.gradle.kts`, `libs.versions.toml`.
