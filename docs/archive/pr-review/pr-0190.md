...
**Files:** `MobileGarage/data/src/commonTest/.../FirebaseDoorFcmRepositoryTest.kt` (new), `testfakes/FakeAppLoggerRepository.kt`, `FakeAppSettingsRepository.kt`, `FakeMessagingBridge.kt`.
