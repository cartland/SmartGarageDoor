...
**Files:** `MobileGarage/data/src/commonMain/.../AuthBridge.kt` (new), `androidApp/auth/FirebaseAuthBridge.kt` (new), `AuthRepository.kt`, `FirebaseAuthRepositoryTest.kt` (new), `testcommon/FakeAppLoggerRepository.kt`, `FakeAuthBridge.kt`, `AppComponent.kt`.
