...
**Files:** `MobileGarage/test-common/src/commonMain/kotlin/com/chriscartland/garage/testcommon/FakeRemoteButtonRepository.kt`, `usecase/.../RemoteButtonViewModelTest.kt`.
