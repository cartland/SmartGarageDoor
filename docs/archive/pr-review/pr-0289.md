...
**Files:** `MobileGarage/usecase/.../FcmRegistrationManager.kt` (new, 110 lines), `DoorViewModel.kt`, `RegisterFcmUseCase.kt`, delete `FcmRegistrationAction.kt` + `FcmRegistration.kt`, `AppStartup.kt`, `AppComponent.kt`, tests.
