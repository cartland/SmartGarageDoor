...
**Files:** `MobileGarage/domain/src/commonMain/.../FetchError.kt` (new), `DoorRepository.kt`, `data/.../NetworkDoorRepository.kt`, `usecase/.../FetchDoorEventsUseCase.kt`, `DoorViewModel.kt`, `DECISIONS.md`, test files.
