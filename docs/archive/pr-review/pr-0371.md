...
**Files:** `MobileGarage/androidApp/src/main/java/com/chriscartland/garage/di/AppComponent.kt`, `ComponentGraphTest.kt`, `MainActivity.kt`, `FCMService.kt`, `LogSummaryCard.kt`, `ProfileContent.kt`.
