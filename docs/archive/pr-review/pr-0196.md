...
**Files:** `MobileGarage/buildSrc/src/main/kotlin/architecture/ArchitectureCheckTask.kt` (new), `SingletonGuardTask.kt` (new), `LayerImportCheckTask.kt` (new), `build.gradle.kts`, `scripts/validate.sh`.
