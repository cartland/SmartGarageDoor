...
**Files:** `.github/workflows/ci-post-merge.yml`, `release-android.yml`, `MobileGarage/androidApp/src/test/.../DaoNullabilityTest.kt` (new, 111 lines), `docs/library-bugs/README.md` (new), `room-nullability.md` (new), `CLAUDE.md`, `scripts/release-android.sh`.
