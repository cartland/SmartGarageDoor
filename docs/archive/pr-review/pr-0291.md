...
**Files:** `MobileGarage/androidApp/ui/*.kt` (7 files), `domain/.../AppClock.kt` (new), `test-common/.../FakeClock.kt` (new), `usecase/.../DoorViewModel.kt`, `DoorViewModelTest.kt`, `AppComponent.kt`, screenshot gallery.
