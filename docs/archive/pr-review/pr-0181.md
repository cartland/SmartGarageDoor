...
**Files:** `MobileGarage/androidApp/.../auth/GoogleSignInState.kt` (new, 142 lines), delete `AuthConstants.kt`, `MainActivity.kt`, `AuthViewModel.kt`, `HomeContent.kt`, `ProfileContent.kt`, `.claude/hooks/git-guardrails.sh`.
