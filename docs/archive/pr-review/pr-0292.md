...
**Files:** `MobileGarage/androidApp/.../DoorStatusCard.kt`, `HomeContent.kt`, `Main.kt`, `OldLastCheckInBanner.kt`, `theme/DoorStatusColorScheme.kt`, `test-common/.../FakeClock.kt`, `usecase/.../DoorViewModelTest.kt`.
