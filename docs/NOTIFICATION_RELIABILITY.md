...
| **R1** | Med | Push data | Missed-push recovery is manual: staleness is auto-detected but only raises a banner; nothing auto-refetches. | `MobileGarage/usecase/.../CheckInStalenessManager.kt:54-104` |
