 ...
 * (`MobileGarage/docs/PENDING_FOLLOWUPS.md` item #1). Forbids hardcoded
        ...
        if (violations.isNotEmpty()) {
            throw GradleException(
                buildString {
                    ...
                    append("(MobileGarage/docs/PENDING_FOLLOWUPS.md item #1):\n")
                    ...
                    append("render time.\n\n")
                    append("Fix:\n")
                    append("  - Add the string to MobileGarage/androidApp/src/main/res/values/strings.xml\n")
                    ...
                    append("  MobileGarage/string-literal-exemptions.txt\n")
