 ...
 *
 * See `MobileGarage/docs/DI_SINGLETON_REQUIREMENTS.md` and
 * `MobileGarage/docs/archive/POSTMORTEM_ANDROID_170.md` for context.
 */
        ...
        if (providerScopeAnnotations > 0 && cachedEntries == 0) {
            throw GradleException(
                buildString {
                    ...
                    append("     MobileGarage/buildSrc/src/main/kotlin/architecture/SingletonCachingCheckTask.kt\n")
