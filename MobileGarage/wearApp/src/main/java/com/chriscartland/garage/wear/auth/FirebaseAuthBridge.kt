...
/**
 * Firebase implementation of [AuthBridge] for Wear OS.
 *
 * Verbatim copy of the phone's `:androidApp` `FirebaseAuthBridge` — the
 * Firebase Auth SDK behaves identically on Wear. Hoisting both copies into a
 * shared Android library module is a noted follow-up (docs/WEAR_OS.md); keep
 * the two files in sync until then.
 */
