...
<!-- Regenerate: ./gradlew -p MobileGarage checkPreviewCoverage -->
...
- `SettingsContentWatchInstalledUnknownVersionPreview` — `androidApp/src/main/java/com/chriscartland/garage/ui/settings/SettingsContent.kt`
