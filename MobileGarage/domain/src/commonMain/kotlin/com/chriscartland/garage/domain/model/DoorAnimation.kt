 ...
 * `MobileGarage/docs/UI_FIDELITY_TIERS.md` § "Animation: split the spec from
 * the execution" and `MobileGarage/docs/DOOR_ANIMATION.md` for the contract.
 *
...
object DoorAnimation {
     ...
     * seed. See `MobileGarage/docs/DOOR_ANIMATION.md` and ADR-025 (amended).
     */
