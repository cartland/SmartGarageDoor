...
- `MobileGarage/docs/DECISIONS.md` — ADR-006, 013, 017, 018, 019, 020,
  021, 022.
- `MobileGarage/docs/archive/VIEWMODEL_SCOPING_ISSUE.md` — the bug that
  motivated this.
- `MobileGarage/docs/MIGRATION.md` — broader migration roadmap
  (Phase 38 for iOS).
