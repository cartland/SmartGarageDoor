...
The task source is `MobileGarage/buildSrc/src/main/kotlin/architecture/SingletonCachingCheckTask.kt`.

### Mechanical: inspect the generated component

```bash
find MobileGarage -path '*/ksp/*' -name 'InjectAppComponent.kt' | head -1
```
