...
|---|---|---|---|---|
| T1 | `CheckInStalenessManager.isCheckInStale` is `Flow`, forcing two default-seeded VM mirrors | **FIXED** (2026-08-14) | Widened to `StateFlow`; both mirrors DELETED (ADR-022 pass-through references, not seeded copies — stronger than the proposed seeding). ADR-015 amended per P3 | Done |
